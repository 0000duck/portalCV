...
namespace Microsoft.AspNet.Identity
{
    public static class IdentityExtension
    {
        ...
        public static bool GetEsAdmin(this IIdentity identity)
        {
            ClaimsIdentity claimsIdentity = identity as ClaimsIdentity;
            Claim claim = claimsIdentity?.FindFirst("esAdmin");
        ...
        public static bool GetEsTecnico(this IIdentity identity)
        {
            ClaimsIdentity claimsIdentity = identity as ClaimsIdentity;
            Claim claim = claimsIdentity?.FindFirst("esTecnico");
        ...
        public static bool GetEsAdministrador(this IIdentity identity)
        {
            ClaimsIdentity claimsIdentity = identity as ClaimsIdentity;
            Claim claim = claimsIdentity?.FindFirst("esAdministrador");
